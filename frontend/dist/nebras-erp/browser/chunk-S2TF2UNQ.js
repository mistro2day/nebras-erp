import{a as j}from"./chunk-6UXR7ML6.js";import{r as S}from"./chunk-PZ6HKFY6.js";import{Ab as A,Bb as z,Kb as E,Lb as x,Ob as B,Pb as $,Tb as P,Ub as N,Wa as F,fa as D,ga as _,gc as w,lb as k,qa as M}from"./chunk-MM2ZWJKN.js";import{g as y}from"./chunk-Z3S5WG22.js";var L="\u0646\u0628\u0631\u0627\u0633 \u2014 \u0646\u0638\u0627\u0645 \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u062F\u0627\u0631\u0633",C="0057B8";function q(e,n){let o=e.map?e.map(n):n[e.key];return o==null?"":String(o)}function U(){return new Date().toLocaleString("en-GB")}function O(e,n){return`${e.filename||e.title}-${new Date().toISOString().slice(0,10)}.${n}`}function R(e,n){let o=URL.createObjectURL(e),t=document.createElement("a");t.href=o,t.download=n,t.click(),setTimeout(()=>URL.revokeObjectURL(o),1e3)}function X(e,n){R(new Blob(["\uFEFF"+n],{type:"text/csv;charset=utf-8;"}),e)}function T(e,n,o){return y(this,null,function*(){let t=yield import("./chunk-NP2SHPK5.js"),l=t.default??t,p=new l.Workbook;p.creator=L,p.created=new Date;let i=p.addWorksheet(e.title.slice(0,28)||"\u062A\u0642\u0631\u064A\u0631",{views:[{rightToLeft:!0,state:"frozen",ySplit:3}]}),u=n.length;i.columns=n.map(c=>({key:c.key,width:c.width??22})),i.mergeCells(1,1,1,u);let f=i.getCell(1,1);f.value=e.title,f.font={bold:!0,size:15,color:{argb:"FF"+C}},f.alignment={horizontal:"right",vertical:"middle"},i.getRow(1).height=26,i.mergeCells(2,1,2,u);let s=i.getCell(2,1);s.value=`${e.subtitle?e.subtitle+"  \u2022  ":""}${L}  \u2022  ${U()}`,s.font={size:10,color:{argb:"FF6B7280"}},s.alignment={horizontal:"right",vertical:"middle"};let r=i.getRow(3);n.forEach((c,m)=>{let d=r.getCell(m+1);d.value=c.label,d.font={bold:!0,color:{argb:"FFFFFFFF"},size:11},d.fill={type:"pattern",pattern:"solid",fgColor:{argb:"FF"+C}},d.alignment={horizontal:"right",vertical:"middle"},d.border={bottom:{style:"thin",color:{argb:"FFD6DBE6"}}}}),r.height=20,o.forEach((c,m)=>{let d=i.getRow(4+m);n.forEach((b,h)=>{let g=d.getCell(h+1);g.value=b.map?b.map(c):c[b.key],g.alignment={horizontal:b.align==="end"?"left":"right",vertical:"middle"},m%2===1&&(g.fill={type:"pattern",pattern:"solid",fgColor:{argb:"FFFAFBFD"}}),g.border={bottom:{style:"hair",color:{argb:"FFE5E8EF"}}}})});let a=yield p.xlsx.writeBuffer();R(new Blob([a],{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}),O(e,"xlsx"))})}function W(e,n,o){let t=j(),l=n.map(a=>`<th style="text-align:${a.align==="end"?"left":"right"}">${a.label}</th>`).join(""),p=o.map(a=>"<tr>"+n.map(c=>`<td style="text-align:${c.align==="end"?"left":"right"}">${q(c,a)}</td>`).join("")+"</tr>").join(""),i=`${e.title} ${e.subtitle||""}`,u=/مال|سند|قبض|صرف|فاتورة|رسوم|حساب|ميزانية|أستاذ|مشتريات|خزينة|رواتب|استحقاق/i.test(i),f=/غياب|حضور|أكاديم|متابع|درجات|امتحان|تقييم|جدول|فصل|شعبة|إنذار/i.test(i),s=t.stampUrl,r="\u0627\u0644\u062E\u062A\u0645 \u0627\u0644\u0631\u0633\u0645\u064A \u0644\u0644\u0645\u0624\u0633\u0633\u0629";return u&&(t.stampFinanceUrl||t.stampUrl)?(s=t.stampFinanceUrl||t.stampUrl,r="\u062E\u062A\u0645 \u0627\u0644\u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u0627\u0644\u064A\u0629 \u0648\u0627\u0644\u062E\u0632\u064A\u0646\u0629"):f&&(t.stampAcademicUrl||t.stampUrl)&&(s=t.stampAcademicUrl||t.stampUrl,r="\u062E\u062A\u0645 \u0627\u0644\u0634\u0624\u0648\u0646 \u0627\u0644\u0623\u0643\u0627\u062F\u064A\u0645\u064A\u0629 \u0648\u0627\u0644\u0645\u062A\u0627\u0628\u0639\u0629"),`
    <div class="nb-doc" dir="rtl">
      <div class="nb-doc-head">
        <div class="nb-doc-titles">
          <h1>${e.title}</h1>
          ${e.subtitle?`<div class="nb-doc-sub">${e.subtitle}</div>`:""}
          <div class="nb-doc-meta-info">\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u062A\u0642\u0631\u064A\u0631: ${U()} \u2022 \u0639\u062F\u062F \u0627\u0644\u0633\u062C\u0644\u0627\u062A: ${o.length}</div>
        </div>
        <div class="nb-doc-brand">
          <div class="b-ministry">\u062C\u0645\u0647\u0648\u0631\u064A\u0629 \u0627\u0644\u0633\u0648\u062F\u0627\u0646 \u2022 \u0648\u0632\u0627\u0631\u0629 \u0627\u0644\u062A\u0639\u0644\u064A\u0645 \u0648\u0627\u0644\u062A\u0631\u0628\u064A\u0629 \u0627\u0644\u0648\u0637\u0646\u064A\u0629</div>
          <div class="b1">${t.schoolNameAr}</div>
          <div class="b2">${t.schoolNameEn}</div>
          <div class="b-contact">${t.address||""}</div>
        </div>
        ${t.logoUrl?`<div class="nb-doc-logo"><img src="${t.logoUrl}" alt="\u0634\u0639\u0627\u0631 \u0627\u0644\u0645\u062F\u0631\u0633\u0629" class="doc-logo-img" onerror="this.style.display='none'"></div>`:""}
      </div>
      ...
      <div class="nb-doc-foot">
        <span>${t.schoolNameAr} \u2022 ${t.phonesFormatted||t.phone||""}</span>
  ...
  * { font-family: 'Segoe UI', Tahoma, 'Arial', sans-serif; box-sizing: border-box; }
  ...
  .nb-stamp-ph { font-size: 8px; color: #${C}; border: 1px dashed #${C}; border-radius: 50%; width: 38px; height: 38px; display: flex; align-items: center; justify-content: center; text-align: center; transform: rotate(-5deg); font-weight: 700; }
...
`;function I(e,n,o){let t=e.orientation==="landscape",l=t?"@page { size: A4 landscape; margin: 10mm 15mm; }":"@page { size: A4 portrait; margin: 15mm; }",p=`<!doctype html><html dir="rtl" lang="ar"><head><meta charset="utf-8"><title>${e.title}</title>
    <style>${H} ${l} @media print{.nb-doc{padding:0}}</style></head>
    <body>${W(e,n,o)}<script>window.onload=()=>window.print()<\/script></body></html>`,i=window.open("","_blank",t?"width=1150,height=750":"width=980,height=720");i&&(i.document.open(),i.document.write(p),i.document.close())}function G(e,n,o){return y(this,null,function*(){let[t,l]=yield Promise.all([import("./chunk-QAFPTA2O.js"),import("./chunk-N2LKX7ET.js")]),p=t.jsPDF??t.default,i=l.default??l,u=e.orientation==="landscape",f=u?1122:794,s=document.createElement("div");s.setAttribute("dir","rtl"),s.style.cssText=`position:fixed; top:0; inset-inline-start:-10000px; width:${f}px; background:#fff; z-index:-1;`,s.innerHTML=`<style>${H}</style>${W(e,n,o)}`,document.body.appendChild(s);try{let r=yield i(s,{scale:2,backgroundColor:"#ffffff",useCORS:!0}),a=new p(u?"l":"p","mm","a4"),c=u?297:210,m=u?210:297,d=c,b=r.height*d/r.width,h=r.toDataURL("image/png"),g=b,v=0;for(a.addImage(h,"PNG",0,v,d,b),g-=m;g>0;)v-=m,a.addPage(),a.addImage(h,"PNG",0,v,d,b),g-=m;a.save(O(e,"pdf"))}finally{document.body.removeChild(s)}})}function Y(e,n,o){return y(this,null,function*(){let t=typeof e=="string"?document.getElementById(e):e;if(!t)return;let[l,p]=yield Promise.all([import("./chunk-QAFPTA2O.js"),import("./chunk-N2LKX7ET.js")]),i=l.jsPDF??l.default,u=p.default??p,f=o?.scale??2.5,s=o?.orientation??"p",r=yield u(t,{scale:f,backgroundColor:"#ffffff",useCORS:!0,logging:!1}),a=new i(s,"mm","a4"),c=s==="p"?210:297,m=s==="p"?297:210,d=c,b=r.height*d/r.width,h=r.toDataURL("image/png"),g=b,v=0;for(a.addImage(h,"PNG",0,v,d,b),g-=m;g>5;)v-=m,a.addPage(),a.addImage(h,"PNG",0,v,d,b),g-=m;let V=n.endsWith(".pdf")?n:`${n}.pdf`;a.save(V)})}function K(e,n){if(e&1){let o=B();E(0,"button",5),P("click",function(){D(o);let l=N();return _(l.doPrint())}),E(1,"span",2),w(2,"\u{1F5A8}\uFE0F"),x(),w(3," \u0637\u0628\u0627\u0639\u0629"),x()}}var J=class e{columns=[];rows=[];title="";subtitle;filename;showPrint=!0;customPrint;customPdf;busy=M(!1);meta(){return{title:this.title,subtitle:this.subtitle,filename:this.filename}}doPrint(){if(this.customPrint){this.customPrint();return}I(this.meta(),this.columns,this.rows)}doExcel(){return y(this,null,function*(){this.busy.set(!0);try{yield T(this.meta(),this.columns,this.rows)}finally{this.busy.set(!1)}})}doPdf(){return y(this,null,function*(){if(this.customPdf){this.customPdf();return}this.busy.set(!0);try{yield G(this.meta(),this.columns,this.rows)}finally{this.busy.set(!1)}})}static \u0275fac=function(o){return new(o||e)};static \u0275cmp=k({type:e,selectors:[["nb-export-menu"]],inputs:{columns:"columns",rows:"rows",title:"title",subtitle:"subtitle",filename:"filename",showPrint:"showPrint",customPrint:"customPrint",customPdf:"customPdf"},decls:10,vars:3,consts:[[1,"nb-exp"],["title","\u062A\u0635\u062F\u064A\u0631 Excel",1,"nb-exp-btn","xl",3,"click","disabled"],[1,"ico"],["title","\u062A\u0635\u062F\u064A\u0631 PDF",1,"nb-exp-btn","pdf",3,"click","disabled"],["title","\u0637\u0628\u0627\u0639\u0629",1,"nb-exp-btn"],["title","\u0637\u0628\u0627\u0639\u0629",1,"nb-exp-btn",3,"click"]],template:function(o,t){o&1&&(E(0,"div",0)(1,"button",1),P("click",function(){return t.doExcel()}),E(2,"span",2),w(3,"\u25A4"),x(),w(4," Excel "),x(),E(5,"button",3),P("click",function(){return t.doPdf()}),E(6,"span",2),w(7,"\u25A6"),x(),w(8," PDF "),x(),A(9,K,4,0,"button",4),x()),o&2&&(F(),$("disabled",t.busy()),F(4),$("disabled",t.busy()),F(4),z(t.showPrint?9:-1))},dependencies:[S],styles:[".nb-exp[_ngcontent-%COMP%]{display:inline-flex;align-items:center;gap:6px}.nb-exp-btn[_ngcontent-%COMP%]{display:inline-flex;align-items:center;gap:5px;height:34px;padding:0 12px;font-family:var(--nb-font-family);font-size:12px;font-weight:600;cursor:pointer;border:1px solid var(--nb-border);border-radius:var(--nb-radius);background:var(--nb-surface-raised);color:var(--nb-text);white-space:nowrap;transition:all .15s ease}.nb-exp-btn[_ngcontent-%COMP%]:hover:not(:disabled){border-color:var(--nb-primary-400);color:var(--nb-primary-700)}.nb-exp-btn[_ngcontent-%COMP%]:disabled{opacity:.55;cursor:not-allowed}.nb-exp-btn[_ngcontent-%COMP%]   .ico[_ngcontent-%COMP%]{font-size:13px;line-height:1}.nb-exp-btn.xl[_ngcontent-%COMP%]{color:#157347}.nb-exp-btn.xl[_ngcontent-%COMP%]:hover:not(:disabled){border-color:#157347}.nb-exp-btn.pdf[_ngcontent-%COMP%]{color:#c0392b}.nb-exp-btn.pdf[_ngcontent-%COMP%]:hover:not(:disabled){border-color:#c0392b}"],changeDetection:0})};export{X as a,I as b,Y as c,J as d};
