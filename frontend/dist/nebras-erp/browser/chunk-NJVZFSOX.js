import{a as _}from"./chunk-STSCDPFS.js";function N(t,b="\u062C\u0646\u064A\u0647 \u0633\u0648\u062F\u0627\u0646\u064A"){if(!t||t<=0)return"\u0635\u0641\u0631 "+b;let u=["","\u0648\u0627\u062D\u062F","\u0627\u062B\u0646\u0627\u0646","\u062B\u0644\u0627\u062B\u0629","\u0623\u0631\u0628\u0639\u0629","\u062E\u0645\u0633\u0629","\u0633\u062A\u0629","\u0633\u0628\u0639\u0629","\u062B\u0645\u0627\u0646\u064A\u0629","\u062A\u0633\u0639\u0629","\u0639\u0634\u0631\u0629","\u0623\u062D\u062F \u0639\u0634\u0631","\u0627\u062B\u0646\u0627 \u0639\u0634\u0631","\u062B\u0644\u0627\u062B\u0629 \u0639\u0634\u0631","\u0623\u0631\u0628\u0639\u0629 \u0639\u0634\u0631","\u062E\u0645\u0633\u0629 \u0639\u0634\u0631","\u0633\u062A\u0629 \u0639\u0634\u0631","\u0633\u0628\u0639\u0629 \u0639\u0634\u0631","\u062B\u0645\u0627\u0646\u064A\u0629 \u0639\u0634\u0631","\u062A\u0633\u0639\u0629 \u0639\u0634\u0631"],d=["","","\u0639\u0634\u0631\u0648\u0646","\u062B\u0644\u0627\u062B\u0648\u0646","\u0623\u0631\u0628\u0639\u0648\u0646","\u062E\u0645\u0633\u0648\u0646","\u0633\u062A\u0648\u0646","\u0633\u0628\u0639\u0648\u0646","\u062B\u0645\u0627\u0646\u0648\u0646","\u062A\u0633\u0639\u0648\u0646"],v=["","\u0645\u0627\u0626\u0629","\u0645\u0627\u0626\u062A\u0627\u0646","\u062B\u0644\u0627\u062B\u0645\u0627\u0626\u0629","\u0623\u0631\u0628\u0639\u0645\u0627\u0626\u0629","\u062E\u0645\u0633\u0645\u0627\u0626\u0629","\u0633\u062A\u0645\u0627\u0626\u0629","\u0633\u0628\u0639\u0645\u0627\u0626\u0629","\u062B\u0645\u0627\u0646\u0645\u0627\u0626\u0629","\u062A\u0633\u0639\u0645\u0627\u0626\u0629"];function c(f){let r="",m=Math.floor(f/100),l=f%100;if(m>0&&(r+=v[m]),l>0)if(r&&(r+=" \u0648"),l<20)r+=u[l];else{let w=Math.floor(l/10),o=l%10;o>0&&(r+=u[o]+" \u0648"),r+=d[w]}return r}let p=Math.floor(t),e="",s=Math.floor(p/1e6),i=Math.floor(p%1e6/1e3),g=p%1e3;return s>0&&(s===1?e+="\u0645\u0644\u064A\u0648\u0646":s===2?e+="\u0645\u0644\u064A\u0648\u0646\u0627\u0646":s>=3&&s<=10?e+=c(s)+" \u0645\u0644\u0627\u064A\u064A\u0646":e+=c(s)+" \u0645\u0644\u064A\u0648\u0646"),i>0&&(e&&(e+=" \u0648"),i===1?e+="\u0623\u0644\u0641":i===2?e+="\u0623\u0644\u0641\u0627\u0646":i>=3&&i<=10?e+=c(i)+" \u0622\u0644\u0627\u0641":e+=c(i)+" \u0623\u0644\u0641"),g>0&&(e&&(e+=" \u0648"),e+=c(g)),`\u0641\u0642\u0637 ${e} ${b} \u0644\u0627 \u063A\u064A\u0631`}function U(t,b,u){if(!t)return;let d=_(b),v=d.schoolNameAr,c=d.schoolNameEn,p=d.logoUrl,e=d.phone,s=d.email,i=d.address,g=t.lines||[],f=g.reduce((a,n)=>a+(Number(n.debit)||0),0),r=g.reduce((a,n)=>a+(Number(n.credit)||0),0),m=N(f,"\u062C\u0646\u064A\u0647 \u0633\u0648\u062F\u0627\u0646\u064A"),l=new Date,w=`${l.toISOString().split("T")[0]} ${l.toLocaleTimeString("ar-SD",{hour:"2-digit",minute:"2-digit"})}`,o=t.partner_details,x=t.source_details,y=t.fee_breakdown||[],z=g.map((a,n)=>`
    <tr>
      <td class="center mono">${n+1}</td>
  ...
  `).join(""),$="";o&&($=`
      <div class="partner-box">
        <div class="p-header">
          <span class="badge-role">${o.partner_type_label||"\u0627\u0644\u0637\u0631\u0641 \u0627\u0644\u0645\u0639\u0646\u064A"}</span>
          <h3 class="p-name">${o.name}</h3>
          ${o.student_number?`<span class="p-id mono">\u0627\u0644\u0631\u0642\u0645 \u0627\u0644\u0623\u0643\u0627\u062F\u064A\u0645\u064A: ${o.student_number}</span>`:""}
        </div>
        <div class="p-grid">
          ${o.grade_name?`<div><span class="lbl">\u0627\u0644\u0635\u0641 / \u0627\u0644\u0645\u0631\u062D\u0644\u0629:</span> <span class="val">${o.grade_name}</span></div>`:""}
          ${o.guardian_name?`<div><span class="lbl">\u0648\u0644\u064A \u0627\u0644\u0623\u0645\u0631:</span> <span class="val">${o.guardian_name}</span></div>`:""}
    ...
    `);let k="";y.length>0&&(k=`
      <div class="fee-section">
        ...
        <table class="fee-table">
          ...
          <tbody>${y.map(n=>`
      <tr>
        <td><strong>${n.fee_name}</strong></td>
        <td>${n.description||n.fee_name}</td>
        <td class="mono center">${n.invoice_number||"\u2014"}</td>
        <td class="end mono font-bold">${Number(n.allocated_amount||n.amount).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} \u062C.\u0633</td>
      </tr>
    `).join("")}</tbody>
        </table>
      </div>
    `);let S={draft:"\u0645\u0633\u0648\u062F\u0629 \u0645\u0628\u062F\u0626\u064A\u0629",approved:"\u0642\u064A\u062F \u0645\u0639\u062A\u0645\u062F",posted:"\u0645\u0631\u062D\u0644 \u0644\u062F\u0641\u062A\u0631 \u0627\u0644\u0623\u0633\u062A\u0627\u0630 \u0627\u0644\u0639\u0627\u0645",reversed:"\u0642\u064A\u062F \u0645\u062D\u0627\u0633\u0628\u064A \u0645\u0639\u0643\u0648\u0633",cancelled:"\u0645\u0644\u063A\u064A"}[t.status]||t.status,D=`<!doctype html>
  ...
  <div class="print-sheet">
    ...
    <header class="tenant-header">
      <div class="org-meta">
        ...
        <p class="contact-line">\u{1F4CD} ${i} \u2022 \u0647\u0627\u062A\u0641: ${e} \u2022 \u0628\u0631\u064A\u062F: ${s}</p>
      </div>
      <div class="logo-box">
      ...
      <table class="journal-table">
        ...
        <tfoot>
          <tr>
            ...
            <td class="end mono text-success"><strong>${r.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}</strong></td>
          </tr>
        </tfoot>
      </table>
    </div>
...
</html>`,h=window.open("","_blank","width=1000,height=800,menubar=no,toolbar=no,location=no,status=no");if(!h){console.warn("\u062A\u0639\u0630\u0631 \u0641\u062A\u062D \u0646\u0627\u0641\u0630\u0629 \u0627\u0644\u0637\u0628\u0627\u0639\u0629 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629\u060C \u064A\u0631\u062C\u0649 \u0627\u0644\u0633\u0645\u0627\u062D \u0628\u0627\u0644\u0646\u0648\u0627\u0641\u0630 \u0627\u0644\u0645\u0646\u0628\u062B\u0642\u0629 \u0644\u0644\u0645\u062A\u0635\u0641\u062D.");return}h.document.open(),h.document.write(D),h.document.close()}export{N as a,U as b};
