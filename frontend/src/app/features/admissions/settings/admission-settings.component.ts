...
١. أن يكون عمر الطالب مناسبًا للصف المتقدَّم له وفق لائحة وزارة التعليم والتربية الوطنية.
        ...
        <nb-panel [title]="'الرسوم الدراسية المعروضة في استمارة التقديم — ' + tabTitle()"
          ...
          <div class="fld" style="margin-top:12px">
            ...
            <textarea rows="4" [(ngModel)]="feeInstallmentsText"
                      placeholder="القسط الأول | 500000 | استحقاق شهر 11 (نوفمبر)&#10;القسط الثاني والأخير | 500000 | بداية شهر 1 (يناير) - آخر موعد للسداد"></textarea>
          </div>
          <div class="fld" style="margin-top:12px">
            <label>ملاحظات وشروط الرسوم (سطر لكل ملاحظة)</label>
            <textarea rows="4" [(ngModel)]="feeNotesText"
                      placeholder="تسدد رسوم التسجيل (300,000 جنيه) فوراً عند التسجيل وتعتبر نهائية ولا ترد.&#10;تسدد الرسوم الدراسية على قسطين متساويين: شهر 11 وبداية شهر 1.&#10;لا ترد الرسوم الدراسية بعد مضي الأسبوع الأول من بداية العام الدراسي."></textarea>
          </div>
        </nb-panel>
