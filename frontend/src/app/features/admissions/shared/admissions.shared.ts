...
export const DEFAULT_ADMISSION_FEES: AdmissionFees = {
  ...
  fee_currency: 'جنيه',
  fee_installments: [
    { title: 'القسط الأول', amount: 500000, note: 'استحقاق شهر 11 (نوفمبر)' },
    { title: 'القسط الثاني والأخير', amount: 500000, note: 'استحقاق بداية شهر 1 (يناير) - آخر موعد للسداد' },
  ],
  fee_notes: [
    'تسدد رسوم التسجيل (300,000 جنيه) فوراً عند التسجيل وتعتبر نهائية ولا ترد بعد سدادها.',
    'تسدد الرسوم الدراسية (1,000,000 جنيه) على قسطين متساويين: 500,000 في شهر 11، و 500,000 في بداية شهر 1.',
    'تخصم إدارة المدرسة رسوم التسجيل والإجراءات في حال انسحاب الطالب خلال الأسبوع الأول من بدء العام الدراسي.',
    'لا ترد الرسوم الدراسية بعد مضي الأسبوع الأول من بداية الدراسة وفق اللائحة المدرسية المنظمة.',
  ],
};
