...
const FALLBACK_TEMPLATES: CommunicationTemplate[] = [
  ...
  {
    id: 't-adm-enrolled',
    name: 'إشعار تسجيل واعتماد التلميذ كطالب رسمي ولائحة التسجيل',
    code: 'ADM_ENROLLED',
    category: 'admission',
    language: 'ar',
    subject: 'إشعار اعتماد وتسجيل التلميذ - مدارس نبراس التعليمية',
  ...
  },
  {
    ...
    category: 'admission',
    language: 'ar',
    subject: 'إشعار استلام طلب الالتحاق - مدارس نبراس التعليمية',
    body: 'السلام عليكم {{guardian_name}}، تم استلام طلب الالتحاق بنجاح بالرقم: ({{application_number}}) للتلميذ/ة ({{student_name}}) بـ ({{school_name}}) للعام الدراسي ({{academic_year}}). نرجو الاحتفاظ برقم الطلب لمتابعة حالة القبول.',
    content_type: 'plain_text',
    is_active: true,
    version_count: 1,
  },
  {
    ...
    category: 'admission',
    language: 'ar',
    subject: 'إشعار قبول التلميذ المعتمد - مدارس نبراس التعليمية',
    body: 'السلام عليكم {{guardian_name}}، نبارك لكم قبول التلميذ/ة {{student_name}} بـ {{school_name}} للعام الدراسي. رقم الطلب: {{application_number}}. نرجو مراجعة قسم التسجيل لاستكمال الإجراءات.',
    content_type: 'plain_text',
    is_active: true,
    version_count: 1,
  },
  {
    id: 't-payment-receipt',
    name: 'إشعار سند قبض وسداد رسوم دراسية',
    code: 'PAYMENT_RECEIPT',
    category: 'finance',
    language: 'ar',
    subject: 'سند قبض وسداد رسوم دراسية - مدارس نبراس التعليمية',
