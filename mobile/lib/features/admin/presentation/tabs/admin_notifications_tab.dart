        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: Colors.amber.shade900.withAlpha(50), blurRadius: 14, offset: const Offset(0, 6)),
              ],
            ),
            child: Row(
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('مركز التعاميم والبث الفوري',
                          style: GoogleFonts.tajawal(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white)),
                      const SizedBox(height: 4),
                      Text('إرسال إشعارات عاجلة لأولياء الأمور والمعلمين',
                          style: GoogleFonts.tajawal(fontSize: 12, color: Colors.white.withAlpha(220))),
                    ],
                  ),
                ),
                ElevatedButton(
                  ...
                  child: Text('بث جديد', style: GoogleFonts.tajawal(fontSize: 13, fontWeight: FontWeight.bold)),
                ),
              ],
            ),
          ),
          ...
          Text('نماذج العمليات اليومية الأكثر استخداماً',
          ...
          _buildFormLauncherCard(
            ...
            description: 'إذن مغادرة طالب أثناء الدوام المدرسي وتسليمه لولي الأمر عند البوابة.',
          ...
          _buildFormLauncherCard(
            ...
            description: 'توثيق مخالفة أو تميز سلوكي لطالب مع إشعار ولي أمره آلياً.',
            ...
            onTap: () {
              showNebrasMessageModal(
                ...
                message: 'تم فتح نافذة الرصد وتوثيق الواقعة في ملف الطالب الأكاديمي.',
              );
            },
          ),
          const SizedBox(height: 10),
          ...
          _buildFormLauncherCard(
            ...
            description: 'تحويل حالة الغياب من غير مبرر إلى غياب رسمي معتمد مع إرفاق التقرير.',
            ...
            onTap: () {
              showNebrasMessageModal(
                ...
                message: 'تم توثيق وتأكيد العذر النظامي في سجلات الحضور والانصراف.',
              );
            },
          ),
          ...
          Text('التعاميم المدرسية الأخيرة',
              style: GoogleFonts.tajawal(fontSize: 16, fontWeight: FontWeight.bold, color: NebrasTheme.textDark)),
          const SizedBox(height: 10),
          ...
          _buildRecentAnnouncement(
            ...
            date: 'اليوم • 07:15 ص',
            content: 'نود إحاطتكم بأن الاصطفاف الصباحي سيبدأ غداً في تمام الساعة 07:15 صباحاً.',
          ),
          const SizedBox(height: 10),
          ...
          _buildRecentAnnouncement(
            ...
            date: 'أمس • 01:30 م',
            content: 'سيعقد الاجتماع الدوري لمراجعة مخرجات اختبارات منتصف الفصل في القاعة الرئيسية.',
          ),
        ],
      ),
    );
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(title, style: GoogleFonts.tajawal(fontSize: 14, fontWeight: FontWeight.bold, color: NebrasTheme.textDark)),
                  const SizedBox(height: 3),
                  Text(description, style: GoogleFonts.tajawal(fontSize: 11, color: NebrasTheme.textMuted)),
                ],
              ),
            ),
            const Icon(Icons.arrow_back_ios_new_rounded, size: 14, color: NebrasTheme.textMuted),
          ],
        ),
      ),
    );
        ...
        children: [
          Row(
            children: [
              Text(title, style: GoogleFonts.tajawal(fontSize: 14, fontWeight: FontWeight.bold, color: NebrasTheme.textDark)),
              const Spacer(),
              Text(date, style: GoogleFonts.tajawal(fontSize: 11, color: NebrasTheme.textMuted)),
            ],
          ),
          const SizedBox(height: 4),
          Container(
            ...
            child: Text(target, style: GoogleFonts.tajawal(fontSize: 10, color: Colors.blue.shade800, fontWeight: FontWeight.bold)),
          ),
          const SizedBox(height: 6),
          Text(content, style: GoogleFonts.tajawal(fontSize: 12, color: NebrasTheme.textMuted)),
        ],
      ),
    );
  }
