...
- **بطاقة وتفاصيل الطالب (`/students/details/:id`)**:
  ...
  - **شريط العمليات الموحد والقائمة المنسدلة (Consolidated Actions Bar)**:
    ...
    * دمج كافة العمليات الإدارية وتغيير الحالات ضمن قائمة منسدلة فاخرة بنظام Nebras OS: `[⚡ إجراءات وعمليات الطالب ▼]` تشمل (تعديل الصف والفصل، تفعيل حساب بوابة الطالب مع مؤشر المعالجة، تخريج الطالب، تسجيل انسحاب، أرشفة الملف، وحذف الطالب نهائياً مع صندوق تأكيد محمي).
