...
* `/finance/dashboard` - لوحة التحكم المالية الرئيسية.
* `/finance/coa` - إدارة واستعراض شجرة الحسابات.
* `/finance/journals` - محرر القيود وطلبات الاعتماد والترحيل.
* `/finance/ledger` - استعراض دفتر الأستاذ العام وتفاصيل الحركات الحسابية.
