...
WELCOME_TEMPLATES = {
    ...
    'ADM_ENROLLED': (
        'إشعار تسجيل واعتماد التلميذ كطالب رسمي ولائحة التسجيل', 'whatsapp',
        'اعتماد تسجيل الطالب ولائحة التسجيل',
    ...
    'PAYMENT_RECEIPT': (
        'إشعار سند قبض وسداد رسوم دراسية', 'whatsapp',
        'سند قبض وسداد رسوم دراسية',
        'السلام عليكم ورحمة الله وبركاته،\n'
        'عزيزي ولي الأمر {{guardian_name}} المحترم،\n'
