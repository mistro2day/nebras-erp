...
ADMISSIONS_DEFAULT_TEMPLATES = {
    'ADM_SUBMITTED': (
        ...
        'للتلميذ/ة ({{student_name}}) بـ ({{school_name}}) - مدارس المورد الجديدة للتعليم الخاص للعام الدراسي ({{academic_year}}). '
    ...
    'ADM_ACCEPTED': (
        ...
        'مدارس المورد الجديدة للتعليم الخاص للعام الدراسي. رقم الطلب: {{application_number}}. نرجو مراجعة قسم التسجيل لاستكمال الإجراءات.'
    ),
    'ADM_WAITLIST': (
    ...
    'ADM_REJECTED': (
        ...
        'السلام عليكم {{guardian_name}}، نشكركم للتواصل مع مدارس المورد الجديدة للتعليم الخاص. نود إحاطتكم باكتفاء المقاعد المتاحة '
